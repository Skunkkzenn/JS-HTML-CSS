...
function PagamentoSubscricao(mes, valor){
    if(mes > 0 && mes < 13){
        atraso = mes - 1 // Mês atual menos o mês de janeiro
        let valorTotal = valor * Math.pow((1 + 0.05), atraso)
...
console.log(PagamentoSubscricao(4, 100))

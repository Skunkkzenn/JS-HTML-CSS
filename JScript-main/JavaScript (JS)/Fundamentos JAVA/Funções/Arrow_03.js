// É preciso muito cuidado ao manipular o this e atribuir determinado atributo dentro do escopo de uma função, pois estaremos mexendo no escopo global
...
// O this numa função arrow, não vai variar de forma alguma, pois o this está associado ao contexto no qual a função foi escrita. 
// Não existirá variação, mesmo utilizando o bind.

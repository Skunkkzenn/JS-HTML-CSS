...
const fun2 = function () {} // função anónima

//Armazenar em um array
const array = [function (a, b) {return a + b}, fun1, fun2] //Tanto podemos armazenar uma função de forma literal, quanto alocar uma funcao dentro do array
...
//Passar função com parâmetro de entrada
function run(fun3){
    fun3( )
}
